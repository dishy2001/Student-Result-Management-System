...
public class studentHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Dishu\\Documents\\NetBeansProjects\\SRMS\\src\\back (3).png")); // NOI18N
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            ResultSet rs=st.executeQuery("select * from student inner join result where student.rollno='"+rollno+"' and student.rollno='"+rollno+"'");
            if(rs.next()){
                //for displaying name and all
                jTextField1.setText(rs.getString(2)); // 2 is column number of the table in sql
                jTextField2.setText(rs.getString(4));
                jTextField3.setText(rs.getString(5));
                jTextField4.setText(rs.getString(3));
                jTextField6.setText(rs.getString(6));
               // fro displaying marks
